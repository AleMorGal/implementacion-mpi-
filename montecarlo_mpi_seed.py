...
if __name__ == "__main__":
    ...
    if rank == 0:
        ...
        print('\nSe obtuvieron {} combinaciones de un total de {} manos obtenidas en {} simulaciones de partida \n'
              .format(combinaciones, cantidad_simulaciones, simulaciones * (size -1)))
        ...
        print('Flor Imperial {} veces: {}%\n'.format(resultados_finales[8], round(probabilidades[8]*100, 5)))